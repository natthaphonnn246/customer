...
class RegionProductCsvExport
{
    /**

    */
    public function exportProductRegionCsv(Request $request)
    {
        ...
        $date = $from.'_'.'to'.'_'.$to;
        $filename = 'Product_'.$product_id.'_'.$region.'_'.$categories_id.'_'. $date.'.csv';
      ...
      /*            'from' => $request->from ?? '2025-05-20',
             ...
             $sales =  ReportSeller::where('products.product_name', 'NOT LIKE', '%ดีล%')
                                    ->select(
