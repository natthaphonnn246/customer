...
class RegionProductExcelExport
{
    use Exportable;
    /**
    * 
    */
    public function exportProductRegionExcel(Request $request)
    {
        ...
        $date = $from.'_'.'to'.'_'.$to;
        $filename = $product_id.'_'.$region.'_'.$categories_id.'_'. $date.'.csv';
      ...
      /*            'from' => $request->from ?? '2025-05-20',
             ...
             return ReportSeller::where('products.product_name', 'NOT LIKE', '%ดีล%')
                                ...
                                /*     DB::raw('AVG(report_sellers.cost) as average_cost'),
                                    ...
                                    ->downloadExcel('Product_'.$filename.'.'.'xlsx',\Maatwebsite\Excel\Excel::XLSX, true);
