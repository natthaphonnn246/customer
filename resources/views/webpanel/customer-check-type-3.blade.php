...
@section('content')
    ...
    <div class="contentArea w-full max-w-full break-words">
        <div class="py-2"></div>
        <h5 class="!text-gray-600 font-semibold ms-6"><a href="/webpanel/customer" class="!no-underline">ย้อนกลับ</a> | แบบอนุญาต สมพ.2</h5>
     ...
     {{--    <div class="mr-6" style="text-align: right;">
        ...
        <div class="ms-6">
            <nav aria-label="Page navigation example">
                ...
                @if ($page == 1)
                    <a class="page-link" href="/webpanel/customer/status/checktype-3?page={{ 1 }}" aria-label="Previous">
                    <span aria-hidden="true">Previous</span>
                    </a>
                @else
                    <a class="page-link" href="/webpanel/customer/status/checktype-3?page={{ $page-1 }}" aria-label="Previous">
                    <span aria-hidden="true">Previous</span>
                    </a>
                @endif
                </li>
                ...
                @if($total_page > 14)
                    ...
                    @for ($i= 1; $i <= 10 ; $i++)
                    <li class="page-item <?= ($i == $page) ? 'active' : '' ; ?>" ><a class="page-link" href="/webpanel/customer/status/checktype-3?page={{ $i }}">{{ $i }}</a></li>
                    @endfor
                ...
                @if ($page == $total_page)
                    <a class="page-link" href="/webpanel/customer/status/checktype-3?page={{ $page }}" aria-label="Next">
                    <span aria-hidden="true">next</span>
                    </a>
                @else
                    <a class="page-link" href="/webpanel/customer/status/checktype-3?page={{ $page + 1 }}" aria-label="Next">
                    <span aria-hidden="true">next</span>
                    </a>
                @endif
                </li>
