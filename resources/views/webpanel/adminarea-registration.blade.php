...
@section('content')
    ...
    <div class="contentArea w-full max-w-full break-words">
        ...
        <div class="mr-6" style="text-align: right;">
            ...
            <a class="ms-1 !no-underline" href="/webpanel/customer/export/getexcel/getexcel_completed/{{$admin_name->admin_area}}"  id="exportexcel" class="btn" type="submit"  name="" style="width: 180px; padding: 8px;">Export Excel</a>
        ...
        <hr class="my-3" style="color: #8E8E8E; width: 100%;">
         ...
         <!--- search --->
         <div class="mx-8">
            <form class="w-full mt-2" method="get" action="/webpanel/customer/adminarea/{{$admin_name->admin_area}}/new-registration">
                <div class="ms-2 my-2">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td scope="row" class="text-gray-400 text-left px-3 py-4 !text-gray-500"></div>
