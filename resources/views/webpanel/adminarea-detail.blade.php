            ...
            <div class="col-span-3">
                ...
                <!-- Dropdown menu -->
                    <div id="dropdownDivider" class="z-10 hidden divide-y divide-gray-100 shadow-sm w-44" style="text-align: left;">
                        ...
                        <div class="py-2">
                            <a href="/webpanel/customer/adminarea/{{ $admin_name->admin_area }}/purchase/morethan" id="dropdownlist" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 !no-underline text-white text-center">ไม่สั่งเกิน 7 วัน</a>
                        </div>
                        <div class="py-2">
                            <a href="/webpanel/customer/adminarea/{{ $admin_name->admin_area }}/purchase/coming" id="dropdownlist" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 !no-underline text-white text-center">ใกล้ครบกำหนด</a>
                        </div>
                        <div class="py-2">
                            <a href="/webpanel/customer/adminarea/{{ $admin_name->admin_area }}/purchase/normal" id="dropdownlist" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 !no-underline text-white text-center">สั่งซื้อตามปกติ</a>
                        </div>
                        <div class="py-2">
                            <a href="/webpanel/customer/adminarea/{{ $admin_name->admin_area }}/purchase/no-purchase" id="dropdownlist" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 !no-underline text-white text-center">ไม่มีการสั่งซื้อ</a>
                        </div>
