...
@section('content')
    ...
    <div class="contentArea w-full max-w-full break-words">
        <div class="py-2"></div>
        <h5 class="!text-gray-600 font-semibold ms-6"><a href="/webpanel/customer" class="!no-underline">ย้อนกลับ</a> | ปิดบัญชี</h5>
        ...
        <div class="ms-6">
            <nav aria-label="Page navigation example">
                ...
                @if($total_page > 14)
                    ...
                    @for ($i= 1; $i <= 10 ; $i++)
                    <li class="page-item <?= ($i == $page) ? 'active' : '' ; ?>" ><a class="page-link" href="/webpanel/customer/status/inactive?page={{ $i }}">{{ $i }}</a></li>
                    @endfor
