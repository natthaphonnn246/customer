...
@section('content')
    ...
    <div class="contentArea w-full max-w-full break-words">
        <div class="py-2"></div>
        <h5 class="!text-gray-600 font-semibold ms-6"><a href="/webpanel/customer" class="!no-underline">ย้อนกลับ</a> | อัปเดตเอกสาร</h5>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td scope="row" class="text-gray-400 text-left px-3 py-4 !text-gray-500">{{$user_name}}</td>
                        ...
                        <td scope="row" class="text-gray-400 text-center px-3 py-4 !text-gray-500"> <span class="inline-block border-2 border-sky-500 text-sky-500 px-3 py-2 rounded-lg text-sm">ลงทะเบียนใหม่</span></td>
                        @elseif ($status == 'รอดำเนินการ')
                        <td scope="row" class="text-gray-400 text-center px-3 py-4 !text-gray-500"> <span class="inline-block border-2 border-red-500 text-red-500 px-3 py-2 rounded-lg text-sm">รอดำเนินการ</span></td>
                        @elseif ($status == 'ต้องดำเนินการ')
                        <td scope="row" class="text-gray-400 text-center px-3 py-4 !text-gray-500"><span class="inline-block border-2 border-yellow-500 text-yellow-500 px-3 py-2 rounded-lg text-sm">ต้องดำเนินการ</span></td>
                        @elseif ($status == 'ดำเนินการแล้ว')
                        <td scope="row" class="text-gray-400 text-center px-3 py-4 !text-gray-500"> <span class="inline-block border-2 border-green-500 text-green-500 px-3 py-2 rounded-lg text-sm">ดำเนินการแล้ว</span></td>
                        @else
                        <td scope="row" class="text-gray-400 text-center px-3 py-4 !text-gray-500"> </td>
                        @endif

                        @if ($status_update == 'updated')
                        <td scope="row" class="text-gray-400 text-center px-3 py-4 !text-gray-500"> <span class="inline-block border-2 border-red-500 text-red-500 px-3 py-2 rounded-lg text-sm">UPDATE</span></td>
                        @else
                        <td scope="row" class="text-gray-400 text-center px-3 py-4 !text-gray-500"><span class="inline-block border-2 border-gray-400 text-gray-400 px-3 py-2 rounded-lg text-sm">NULL</span></td>
                        @endif

                        <td scope="row" class="text-gray-400 px-3 py-4 !text-gray-500">{{$created_at}}</td>
        ...
        <div class="ms-6">
            <nav aria-label="Page navigation example">
                ...
                @if($total_page > 14)
                    ...
                    @for ($i= 1; $i <= 10 ; $i++)
                    <li class="page-item <?= ($i == $page) ? 'active' : '' ; ?>" ><a class="page-link" href="/webpanel/customer/status/latest_update?page={{ $i }}">{{ $i }}</a></li>
                    @endfor
