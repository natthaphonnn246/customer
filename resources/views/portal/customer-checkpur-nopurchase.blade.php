...
@section('content')
        ...
        <div class="py-2"></div>
        <h5 class="ms-6 !text-gray-600">ร้านค้า : <span class="inline-block border-2 border-sky-500 text-sky-500 px-3 py-2 rounded-lg text-base cursor-pointer">ไม่มีการสั่งซื้อ</span></h5>
        <hr class="my-3">
        ...
        {{-- {{dd($total_page);}} --}}
                ...
                <nav aria-label="Page navigation example">
                    ...
                    @if ($page == 1)
                        <a class="page-link" href="/portal/customer/purchase/no-purchase?page={{ 1 }}" aria-label="Previous">
                        <span aria-hidden="true">Previous</span>
                        </a>
                    @else
                        <a class="page-link" href="/portal/customer/purchase/no-purchase?page={{ $page-1 }}" aria-label="Previous">
                        <span aria-hidden="true">Previous</span>
                        </a>
                    @endif
                    </li>
                    ...
                    @if($total_page > 14)
                        ...
                        @for ($i= 1; $i <= 10 ; $i++)
                        <li class="page-item <?= ($i == $page) ? 'active' : '' ; ?>" ><a class="page-link" href="/portal/customer/purchase/no-purchase?page={{ $i }}">{{ $i }}</a></li>
                        @endfor
                    ...
                    @if ($page == $total_page)
                        <a class="page-link" href="/portal/customer/purchase/no-purchase?page={{ $page }}" aria-label="Next">
                        <span aria-hidden="true">next</span>
                        </a>
                    @else
                        <a class="page-link" href="/portal/customer/purchase/no-purchase?page={{ $page + 1 }}" aria-label="Next">
                        <span aria-hidden="true">next</span>
                        </a>
                    @endif
                    </li>
