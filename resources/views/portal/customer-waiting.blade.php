...
@section('content')
    ...
    <div class="py-2"></div>
    <h5 class="ms-6 !text-gray-600">ร้านค้า : <span class="inline-block border-2 border-red-500 text-red-500 px-3 py-2 rounded-lg text-base cursor-pointer">รอดำเนินการ</span></h5>
    <hr class="my-3">
