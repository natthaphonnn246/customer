...
@section('content')
    ...
    <div class="py-2"></div>
    <h5 class="ms-6 !text-gray-600">ร้านค้า : <span class="inline-block border-2 border-green-500 text-green-500 px-3 py-2 rounded-lg text-base cursor-pointer">ดำเนินการแล้ว</span></h5>
    <hr class="my-3">
            ...
            <div class="row">
                    ...
                    <div style="display: flex; justify-content: center;">
                        <form class="py-3" style="width:80%;" method="get" action="/portal/customer/status/completed">
...
{{-- {{dd($total_page);}} --}}
          ...
          <nav aria-label="Page navigation example">
            ...
            @if ($page == 1)
                <a class="page-link" href="/portal/customer/status/completed?page={{ 1 }}" aria-label="Previous">
                <span aria-hidden="true">Previous</span>
                </a>
            @else
                <a class="page-link" href="/portal/customer/status/completed?page={{ $page - 1 }}" aria-label="Previous">
                <span aria-hidden="true">Previous</span>
                </a>
            @endif
            </li>
            ...
            @if($total_page > 14)
                ...
                @for ($i= 1; $i <= 10 ; $i++)
                <li class="page-item <?= ($i == $page) ? 'active' : '' ; ?>" ><a class="page-link" href="/portal/customer/status/completed?page={{ $i }}">{{ $i }}</a></li>
                @endfor
