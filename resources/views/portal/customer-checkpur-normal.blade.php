...
@section('content')
        ...
        <div class="py-2"></div>
        <h5 class="ms-6 !text-gray-600">ร้านค้า : <span class="inline-block border-2 border-green-500 text-green-500 px-3 py-2 rounded-lg text-base cursor-pointer">สั่งตามปกติ</span></h5>
        <hr class="my-3">
