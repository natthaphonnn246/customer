...
@section('content')
    ...
    <div class="contentArea w-full max-w-full break-words">
        ...
        <div class="py-2"></div>
        <h5 class="!text-gray-600 font-semibold ms-6">แบบอนุญาตขายยา | ข.ย.2</h5>
        <hr class="my-3 !text-gray-400 !border">

        <div class="mr-6" style="text-align: right;">

            <a href="/webpanel/report/product-type/khor-yor-2/export/getcsv/khoryor-2"  id="exportcsv" class="btn" type="submit"  name="" style="width: 150px; padding: 8px;">Export CSV</a>
            <a href="/webpanel/report/product-type/khor-yor-2/export/getexcel/khoryor-2"  id="exportexcel" class="btn" type="submit"  name="" style="width: 150px; padding: 8px;">Export Excel</a>
