<div x-data="{ open: false }">
    ...
    <ul class="p-3 space-y-2 text-white mt-2">
        ...
        <li x-data="{ open: false }" class="relative">
            ...
            <button
                @click="open = !open"
                class="flex items-center gap-2 w-full px-3 py-2 rounded
                ...
                <i
                class="fa-solid fa-chevron-right transform transition-transform duration-300"
            ...
            <ul
                ...
                class="overflow-hidden ml-6 mt-1 border-l border-green-700
                       transition-all duration-300 ease-in-out space-y-1">
        
                <li>
                    <a href="{{ route('admin.register') }}"
                       class="block px-3 py-2 rounded hover:bg-green-800 !no-underline text-white transition">
                        ลงทะเบียนร้านค้า
                    </a>
                </li>
        
                <li>
                    <a href="{{ route('admim.customer') }}"
                       class="block px-3 py-2 rounded hover:bg-green-800 !no-underline text-white transition">
                        ร้านค้า
                    </a>
                </li>
